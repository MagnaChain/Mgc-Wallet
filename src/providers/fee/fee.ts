...
export class FeeProvider {
  ...
  public getFeeRate(
    ...
    this.logger.debug('####################### fee.ts : getFeeRate');
  ...
  public getCurrentFeeRate(coin: string, network: string): Promise<any> {
    this.logger.debug('####################### fee.ts : getCurrentFeeRate');
    return new Promise((resolve, reject) => {
  ...
  public getFeeLevels(coin: string): Promise<any> {
    this.logger.debug('################### fee.ts getFeeLevels');
    return new Promise((resolve, reject) => {
      coin = coin || 'btc';
        ...
        (errLivenet, levelsLivenet) => {
          ...
          walletClient.getFeeLevels(
            ...
            (errTestnet, levelsTestnet) => {
              ...
              this.logger.debug(
                '################### fee.ts levelsLivenet : ' +
                  JSON.stringify(levelsLivenet)
              );

              this.logger.debug(
                '################### fee.ts levelsTestnet : ' +
                  JSON.stringify(levelsTestnet)
              );
