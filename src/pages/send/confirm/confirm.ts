...
export class ConfirmPage {
  ...
  ionViewWillEnter() {
    this.logger.debug('##################### confirm.ts : ionViewWillEnter');
  ...
  private setWalletSelector(
    ...
    this.logger.debug('##################### confirm.ts : setWalletSelector');
  ...
  private setWallet(wallet: any): void {
    this.logger.debug('########################## confirm.ts : setWallet');
    this.wallet = wallet;
  ...
  private updateTx(tx: any, wallet: any, opts: any): Promise<any> {
    this.logger.debug('##################### confirm.ts : updateTx');
    return new Promise((resolve, reject) => {
      if (opts.clearCache) {
        tx.txp = {};
      }
      ...
      this.feeProvider
        ...
        .then((feeRate: any) => {
          this.logger.debug(
            '##################### confirm.ts : updateTx feeRate is ' + feeRate
          );
          let msg;
          if (this.usingCustomFee) {
            this.logger.debug('#################### usingCustomFee');
            msg = this.translate.instant('Custom');
            tx.feeLevelName = msg;
          } else if (this.usingMerchantFee) {
            this.logger.debug('#################### usingMerchantFee');
  ...
  private useSendMax(tx: any, wallet: any, opts: any) {
    this.logger.debug('##################### confirm.ts : useSendMax');
    return new Promise((resolve, reject) => {
  ...
  private buildTxp(tx: any, wallet: any, opts: any): Promise<any> {
    this.logger.debug('##################### confirm.ts : buildTxp');
    return new Promise((resolve, reject) => {
  ...
  private getSendMaxInfo(tx: any, wallet: any): Promise<any> {
    this.logger.debug('##################### confirm.ts : getSendMaxInfo');
    return new Promise((resolve, reject) => {
  ...
  private getTxp(tx: any, wallet: any, dryRun: boolean): Promise<any> {
    this.logger.debug('######################### confirm.ts : getTxp');
    return new Promise((resolve, reject) => {
  ...
  public approve(tx: any, wallet: any): void {
    this.logger.debug('################### approve tx: ' + JSON.stringify(tx) );
    if (!tx || !wallet) return;
  ...
  public chooseFeeLevel(): void {
    this.logger.debug('##################### confirm.ts : chooseFeeLevel');
